...
def test_get_latest_version_success(mock_urlopen):
    ...
    # Use get_header as urllib Request headers might be capitalized or stored differently
    assert args[0].get_header("User-agent") == "Jules-Code-Team-Template-Updater"
