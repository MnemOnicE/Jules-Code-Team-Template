...
def normalize_name(name):
    ...
    normalized = NON_ALPHANUM_RE.sub('', name)
    return normalized
    ...
    with open(filepath, 'r') as f:
        for line in f:
            ...
            if line.startswith('# -'):
                ...
                content = PAREN_CLEANUP_RE.sub('', content).strip()
...
def get_imports_from_file(filepath):
    ...
    if ext == '.py':
        ...
        # require('package')
        cjs_matches = JS_CJS_REQUIRE_RE.findall(content)
